...
<script src="https://kit.fontawesome.com/fbb66f1bce.js" crossorigin="anonymous"></script>
	...
	<title>Comment Error / <?php bloginfo('name'); ?></title>
	...
	body{
		background: #fff url('https://aroceu.com/fic/wp-content/themes/stars/bannerbg.png');
		margin: 0;
    	padding: 0;
          color: #5a4a57;
...
<h1>Error</h1>
	...
	<p>"Brevity is the soul of wit," but your comment needs a name, email, and/or content in the comment box.</p> 
	
	<p>Any fields you filled out will still be there when you go back. Please make sure all required forms are filled out before submitting your comment.</p>
